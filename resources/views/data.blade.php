                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Gambar </label>
                                                <input type="text" class="form-control" name="gambar" value="" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                name="deskripsi" id="deskripsi" style="white-space: pre-wrap;"
                                                value="" cols="70" rows="10" required></textarea>
                                            </div>
                                        </div>
                                    </div>                
                                    <button type="submit" class="btn btn-info btn-fill pull-right" name="register">Simpan</button>
